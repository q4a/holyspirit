...
Bien ! Maintenant que vous avez changé de niveau, retournez dans l'inventaire. Vous pourrez dépenser vos points de caractéristique fraichement acquis en cliquant sur le petit '+' à côté de la caractéristique voulue.
...
Maintenant, ouvrez le menu des miracles en cliquant sur l'icône en forme d'étoile ou en appuyant sur 'T'.\Vous pouvez choisir la voie dans laquelle vous souhaitez dépenser vos points via les 3 boutons à gauche.\Faites un clic droit sur une icône de miracle pour dépenser un point dedans. Un clic gauche le prend en main, vous pouvez ensuite le mettre dans la barre de raccourcis en bas à droite. Vous y accéderez en jeu en appuyant sur les touches F1 à F4 qui permettent de le mettre en mode actif. Il vous suffit de faire ensuite un clic droit pour l'utiliser.
