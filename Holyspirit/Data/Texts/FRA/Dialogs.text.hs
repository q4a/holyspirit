...
Vous allez maintenant combattre un petit groupe d'ennemis qui protège un coffre. Il vous suffit de cliquer dessus pour l'ouvrir.\Maintenez 'Alt' enfoncé pour voir les objets au sol. Ensuite, faites un clique gauche sur le nom de l'objet que vous souhaitez ramasser.
