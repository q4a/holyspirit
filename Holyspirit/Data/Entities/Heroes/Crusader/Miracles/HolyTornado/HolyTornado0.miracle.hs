	...
	*Tornade_divine
$
	*Le_croise_fait_tournoyer_son_épée\repoussant_les_ennemis_en_contact_avec_lui.\Utilisable_uniquement_avec_des_épées_à_deux_mains.\\Dégats_:_5-10\Cout_en_mana_:_20
$
	* f20 e2 $
$
//Images
