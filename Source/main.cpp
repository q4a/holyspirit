...
int main ( int argc, char** argv )
{
    ...
    bool fullscreen=true,video,SyncroVertical;
    ...
    if(fichier)
    {
    	...
    	while(fichier>>chaine)
    	{
    			...
    			if(chaine== "syncronisation_verticale:") { fichier>>SyncroVertical; }
    ...
    else
    {
        ...
        //{
            ...
            while(fichier2>>chaine)
            {
                    ...
                    if(chaine== "herbes:") { fichier>>configuration.Herbes; }
                    if(chaine== "syncronisation_verticale:") { fichier2>>SyncroVertical; }
