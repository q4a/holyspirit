...
sf::Sprite Bouton_pressoire::Afficher(float decalage)
{
    ...
    sprite.setScale(position.w/sprite.getLocalBounds().width,position.h/sprite.getLocalBounds().height);
...
void Border::Afficher(coordonnee pos, coordonnee size, int couche, sf::Color color)
{
    ...
    sprite.setScale(size.x/sprite.getLocalBounds().width,image_u.position.h/sprite.getLocalBounds().height);
    moteurGraphique->AjouterCommande(&sprite,couche,false);
    ...
    sprite.setScale(image_l.position.w/sprite.getLocalBounds().width,size.y/sprite.getLocalBounds().height);
    moteurGraphique->AjouterCommande(&sprite,couche,false);
    ...
    sprite.setScale(image_r.position.w/sprite.getLocalBounds().width,size.y/sprite.getLocalBounds().height);
    moteurGraphique->AjouterCommande(&sprite,couche,false);
