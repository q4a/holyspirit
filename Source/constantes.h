...
enum {AUCUN,ARME,ARMURE,CONSOMMABLE,SCHEMA,LITANIE,JEWELERY,GOLEM};

enum {EFFICACITE_ACCRUE,CARACT_SUPP,POINTS_SUPP,DEGATS_SUPP, ARMURE_SUPP, DEGATS_TEMPS_SUPP};
