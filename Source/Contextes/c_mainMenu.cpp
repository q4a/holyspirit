...
void  c_MainMenu::E_Continuer(Jeu *jeu)
{
                            ...
                            && i < 8 + (unsigned)defilement_saves; ++i)
    {
        ...
        texte_niv.setString(toUtf32(buf.str()));
